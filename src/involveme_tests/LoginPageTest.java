...
public class LoginPageTest extends BaseTest {
	...
	@Test (description ="general test: Open Login Page")
	...
	// test#5
	@Test (description ="test 'see how it works' button")
	public void tc02_SeeHowIFWorks() {
		...
		Assert.assertEquals(actual, "HOW TO USE ONLINE SPREADSHEETS FOR FLEXIBLE REPORTING");
		sleep(2000);
	...
	// test #7
	@Test (description ="test 'about' link at the top menu")
	...
	// test #8
	@Test (description ="test 'Templates' link at the top menu")
	...
	// test #9
	@Test (description ="test 'Integrations' link at the top menu")
	...
	// test #10
	@Test (description ="test 'create an account' page")
