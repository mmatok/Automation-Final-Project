...
public class ProjectsPage extends BasePage {
	...
	@FindBy(css = ".max-w-full.sm\\:px-12.md\\:px-0.md\\:max-w-3xl.lg\\:max-w-6xl.mx-auto.relative.pb-24 > div > div.mt-4.md\\:mt-0.w-full.max-w-4xl > div.px-4.md\\:flex.justify-between.md\\:px-0.md\\:ml-6.lg\\:ml-8.xl\\:ml-12.items-center > a")
	...
	@FindBy(css = ".px-4.md\\:flex.justify-between.md\\:px-0.md\\:ml-6.lg\\:ml-8.xl\\:ml-12.items-center > div > div > button > svg")
	WebElement workspaceDropdown;
	@FindBy(css = ".mt-4.md\\:mt-0.w-full.max-w-4xl > div.px-4.md\\:flex.justify-between.md\\:px-0.md\\:ml-6.lg\\:ml-8.xl\\:ml-12.items-center > div > div > ul > li:nth-child(2) > button")
