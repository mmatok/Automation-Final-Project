...
public class EditorPage extends TopMenu {
	...
	@FindBy(css = ".fal.fa-edit.v-toggle-project.v-toggle-page")
	WebElement backgroundSettingsButton;
	...
	@FindBy(css = ".dropdown.nav-item.show > div > a:nth-child(3)")
	...
	public void editGeneralDesign(String contentPosition, String colorCode) {
		// click on the "change background design settings" button on the right
		click(backgroundSettingsButton);
		sleep(2000);
