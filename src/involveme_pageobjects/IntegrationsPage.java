...
public class IntegrationsPage extends BasePage {
	...
	@FindBy(css = ".col-md-9 > div:nth-child(39) > div:nth-child(4) > div > a > img")
	WebElement deskLinkZapier;
	@FindBy(css = ".css-swtojr-UniversalTopbar__group--medium >div:nth-child(2) > a")
	...
	@FindBy(css = ".css-155ua93-CompaniesIntroPromo .css-scgzbz-Button__buttonContent-Button--buttonContent span")
